...
\begin{equation}
	Q = m_1 \cdot C_1solide \cdot \Delta\theta_{dep a 0} + L_f1 \cdot m_1 + m_1 \cdot C_1liquide \cdot \Delta\theta_{0 a finale}
\end{equation}

On se retrouve dans la logique suivante:
\newline
\newline
Il faut d'abord mener le solide jusqu'à $0\celsius$ ($m_1 \cdot C_1 \cdot \Delta\theta_{dep a 0}$) puis y ajouter la Chaleur latente de fusion ($L_f1 \cdot m_1$) et finalement ajouter l'équation pour passer le liquide à sa température finale ($m_1 \cdot C_1liquide \cdot \Delta\theta_{0 a finale}$)
